...
namespace ClubDeSocios.Controllers
{
    public class SociosController : Controller
    {
        ...
        public ActionResult Index(int? id)
        {
            ...
            return View(db.Socios.ToList().Where(s=>s.SocioID == id));
        }
        ...
        public ActionResult Create([Bind(Include = "SocioID,Nombre,Apellidos,Cedula,Foto,Direccion,TelefonoCelularFax,Sexo,Edad,FechaNacimiento,TipoMembresia,LugarTrabajo,DireccionOficina,TelefonoOficina,EstadoMembresia,FechaIngreso,FechaSalida")] Socio socio, HttpPostedFileBase upload)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SocioID,Nombre,Apellidos,Cedula,Foto,Direccion,TelefonoCelularFax,Sexo,Edad,FechaNacimiento,TipoMembresia,LugarTrabajo,DireccionOficina,TelefonoOficina,EstadoMembresia,FechaIngreso,FechaSalida")] Socio socio, HttpPostedFileBase upload)
        {
